 ...
 */
export function SwingIndicator({ slug, initialSwing, labels }: SwingIndicatorProps) {
  ...
  return (
    <div
      role="status"
      className={cn(
        "mx-auto mt-3 flex w-fit items-center gap-2 rounded-full border px-3.5 py-1.5",
    ...
    >
      ...
      <span className="text-xs font-bold tabular-nums">
        直近{swing.hoursAgo}時間で中立層の{delta}ptが{leaderLabel}へ
      </span>
    </div>
  );
}
